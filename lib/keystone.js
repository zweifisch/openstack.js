...
exports.roleImply = defres("/roles/:role_id/implies", ["role_inference", "role_inference"], {
    create: ['put', '/:implies_role_id']
})
...
exports.policy = defres("/policies", ['policy', 'policies']);

exports.service = defres("/services", "service");
exports.endpoint = defres("/endpoints", "endpoint");

...
let authenticate = (endpoint, user, scope, _interface, language)=> {
    ...
    return rp({
        ...
        transform: (body, resp)=> {
            ...
            body.token.interface = _interface
            body.token.language = language
            return body.token;
        }
    });
};
...
exports.authenticate = (opts)=> {
    ...
    return authenticate(opts.endpoint, user, scope, opts.interface, opts.language);
};

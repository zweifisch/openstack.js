...
exports.availabilityZone = defres("compute", "/os-availability-zone", [null, "availabilityZoneInfo"], {only: ["list"]});
exports.availabilityZoneDetail = defres("compute", "/os-availability-zone/detail", [null, "availabilityZoneInfo"], {only: ["list"]});
